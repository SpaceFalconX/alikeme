    ...
    if(!result[0]['count(`id`)'])  {
      return Promise.join(
       ...
       knex('followers_following').insert({id: 20, follower_id: 17, followed_id: 5}),
        ...
        knex('posts').insert({id: 8, content: "The approach will not be easy. You are required to maneuver straight down this trench and skim the surface to this point. The target area is only two meters wide. It's a small thermal exhaust port, right below the main port. The shaft leads directly to the reactor system. A precise hit will start a chain reaction which should destroy the station. Only a precise hit will set up a chain reaction. The shaft is ray-shielded, so you'll have to use proton torpedoes. That's impossible, even for a computer. It's not impossible. I used to bull's-eye womp rats in my T-sixteen back home. They're not much bigger than two meters. Man your ships! And may the Force be with you!", title: 'Proton Torpedoes', user_id: 7, category_id: 8}),
        knex('posts').insert({id: 9, content: "Few things are more disappointing than finding what seems like the perfect recipe only to click and learn that it has more than 20 ingredients, several of which you've never heard of. True to its name, Minimalist Baker keeps things simple by sticking to 10 ingredients or less and limiting cook time to 30 minutes tops. Bonus: The recipes are anything but boring! From General Tso's tofu stir fry (pictured) to spicy buffalo chickpea wraps to toasted coconut pancakes, the culinary duo (John and Kate) really know how to pack tons of flavor into simple and oh-so-delicious dishes.", title: 'Minimalist Baker', user_id: 8, category_id: 3}),
        knex('posts').insert({id: 10, content: "We are seeking a highly-skilled front-end web developer to support our application and marketing teams by building out clean, scalable, and readable HTML5 and CSS3. We are looking for a pixel perfect developer with a high-standard of quality and deep knowledge of cross-browser implementation. Applicants should have experience building out websites from scratch (no wordpress-only developers) and should understand higher-level development concepts like ' progressive enhancement' and ' responsive design .' We want individuals who are high-energy, self-motivated, and passionate about front-end development.", title: 'Front End Web Developer', user_id: 9, category_id: 7}),
