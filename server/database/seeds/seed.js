...
//new
    knex('posts_tags').insert({id: 15, post_id: 1, tag_id: 14}),
    knex('posts_tags').insert({id: 16, post_id: 2, tag_id: 13}),
    knex('posts_tags').insert({id: 17, post_id: 3, tag_id: 12}),
    knex('posts_tags').insert({id: 18, post_id: 4, tag_id: 11}),
    knex('posts_tags').insert({id: 19, post_id: 5, tag_id: 10}),
    knex('posts_tags').insert({id: 20, post_id: 5, tag_id: 9}),
    knex('posts_tags').insert({id: 21, post_id: 5, tag_id: 8}),
    knex('posts_tags').insert({id: 22, post_id: 7, tag_id: 7}),
    knex('posts_tags').insert({id: 23, post_id: 8, tag_id: 5}),
    knex('posts_tags').insert({id: 24, post_id: 9, tag_id: 1}),
    knex('posts_tags').insert({id: 25, post_id: 10, tag_id: 2}),
    knex('posts_tags').insert({id: 26, post_id: 11, tag_id: 2}),
    knex('posts_tags').insert({id: 27, post_id: 12, tag_id: 1}),
    knex('posts_tags').insert({id: 28, post_id: 13, tag_id: 7}),
    knex('posts_tags').insert({id: 29, post_id: 1, tag_id: 14}),
    knex('posts_tags').insert({id: 30, post_id: 2, tag_id: 13}),
    knex('posts_tags').insert({id: 31, post_id: 3, tag_id: 12}),
    knex('posts_tags').insert({id: 32, post_id: 4, tag_id: 11}),
    knex('posts_tags').insert({id: 33, post_id: 15, tag_id: 10}),
    knex('posts_tags').insert({id: 34, post_id: 16, tag_id: 9}),
    knex('posts_tags').insert({id: 35, post_id: 17, tag_id: 8}),
    knex('posts_tags').insert({id: 36, post_id: 18, tag_id: 7}),
    knex('posts_tags').insert({id: 37, post_id: 18, tag_id: 5}),
    knex('posts_tags').insert({id: 38, post_id: 19, tag_id: 1}),
    knex('posts_tags').insert({id: 39, post_id: 20, tag_id: 2}),
    knex('posts_tags').insert({id: 40, post_id: 21, tag_id: 2}),
    knex('posts_tags').insert({id: 41, post_id: 22, tag_id: 1}),
    knex('posts_tags').insert({id: 42, post_id: 23, tag_id: 7}),
